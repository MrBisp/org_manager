class OrganizationsController < ApplicationController
  ...
  # GET /organizations/new - This is the action that is called when the user clicks on the "Create new organization" button. Doesn't actually save it to the database.
  def new
  ...
  def destroy
    @organization.destroy! # we just use the bang (!) to raise an error if the organization is not found.
